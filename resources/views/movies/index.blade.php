...
@section('content')
    <h1 class="text-2xl font-semibold leading-tigh py-2">
        Listagem dos Filmes
        <a style="text-decoration: none" class="bg-blue-900 rounded text-white py-1 px-4 text-sm" href="{{route('users.create')}}">Adicionar Filme</a>
    </h1>
    ...
    <h2 class="text-2xl font-semibold leading-tigh py-5">Ver filmes disponíveis para Aluguel
      <a style="text-decoration: none" class="bg-blue-900 rounded text-white py-1 px-4 text-sm" href="{{route('users.create')}}">-></a>
    </h2>
@endsection